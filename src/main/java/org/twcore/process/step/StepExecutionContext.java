 ...
 * @param hit         方块点击信息
 */
public record StepExecutionContext<T>(AbstractProcess<T> process, T blockEntity, BlockState blockState, Level world,
     ...
     * 检查步骤执行是否在客户端。
     *
     * <p>这是{@code level.isClient}的快捷方式。</p>
     *
     ...
     */
    public SoundType getItemSounds() {
